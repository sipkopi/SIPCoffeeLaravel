  ...
  <table id="table-user" class="table table-hover display">
    ...
    <tbody class="table-border-bottom-0 mb-5">
      @foreach ($alldata as $p)
        <tr>
          <th >{{$p->id}}</th>
          <td class="p-3">{{$p->nama_varietas}}</td>
          <td class="p-3">{{ number_format($p->harga, 0, ',', '.') }}</td>
          <td>{{$p->sumber}}</td>
          ...
          <td>
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <a class="dropdown-item ssedtt" href="/data/hargakopi/edit/{{$p->id}}"
      ...
      <div class="modal fade" id="tambahModal" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg" role="document">
                          <div class="modal-content">
                            <form method="POST" action="/data/harga/save" enctype="multipart/form-data">
                              @csrf
                            <div class="modal-header">
                              <h3 class="modal-title fw-bold" id="exampleModalLabel3">Tambah Data Harga Kopi</h3>
                              <br>
                            ...
                            <div class="row">
                              <hr class="my-0 mb-4" />
                                <div class="col mb-3">
                                  <label for="nameLarge" class="form-label">Nama Varietas</label>
                                  <input type="text" id="inputAngka" oninput="validateInputangkaa(this)" name="namav" value="" required  class="form-control" placeholder="Arabica" />
                              ...
                              <div class="row g-2 mb-3">
                              <div class="col mb-0">
                              <label for="emailLarge" class="form-label">Harga ( /KG )</label>
                                  <input type="number" name="harga" placeholder="100" required class="form-control"/>
                                </div>

                                <div class="col mb-0">
                                  <label for="emailLarge" class="form-label">Sumber</label>
                                  <input type="text" id="inputAngka" oninput="validateInputangka(this)" name="sumber" required class="form-control"  placeholder="Raisa Kopi" />
...
<script>
  ...
  const forbiddenCharacters = /[-@.,{}><?!#^&*+$%?;:{}()/''"\=_\[\]]/g; // Karakter yang tidak diinginkan, tambahkan \[\] ke dalam ekspresi reguler
