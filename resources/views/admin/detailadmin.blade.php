                        ...
                        <div
                          ...
                          <div class="user-profile-info">
                            ...
                            <ul
                              ...
                              <li class="list-inline-item"><i class="ti ti-color-swatch"></i>Level: {{$main->level}}</li>
                              <li class="list-inline-item"><i class="ti ti-map-pin"></i> {{$main->lokasi}}</li>
                              <li class="list-inline-item"><i class="ti ti-calendar"></i> Joined {{$main->tanggal_create}}</li>
                            </ul>
                          </div>
                          <a 
                          href="/edit/admin/{{$main->user}}" 
